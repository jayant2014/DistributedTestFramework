...
SUITE_NAME="MyProject/SmokeTesting"
TEST_DIR="$TEST_ROOT_DIR/$SUITE_NAME"
TEST_FILE="$TEST_DIR/testfile"
TEST_CONF="$TEST_DIR/SmokeTesting.conf"
...
then
    ...
    run_test SmokeTesting "root $SERVER_HOST $APPLICATION_HOST $MY_HOST1 $MY_HOST2 $MY_HOST3"
    run_test SmokeTesting "testuser $SERVER_HOST $APPLICATION_HOST $MY_HOST1 $MY_HOST2 $MY_HOST3"
else
